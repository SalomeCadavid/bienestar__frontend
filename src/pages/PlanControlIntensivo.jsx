...
function PlanControlIntensivo() {
  ...
  return (
    <div className="plan-detalle-container">
      <h1>PLAN CONTROL INTENSIVO</h1>
      <p>
        Programa integral supervisado para personas con IMC elevado,
        enfocado en salud cardiovascular, movilidad y cambio sostenible.
      </p>
...
export default PlanControlIntensivo;